...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ingredient" do
    assert_difference('Ingredient.count') do
      post ingredients_url, params: { ingredient: { content: @ingredient.content, recipe_id: @ingredient.recipe_id } }
    end
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { content: @ingredient.content, recipe_id: @ingredient.recipe_id } }
